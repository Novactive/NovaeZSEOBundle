...
sudo sed -i "s|return array(|return array('Novactive\\Bundle\\eZSEOBundle\\' => array(\$vendorDir . '/novactive/ezseobundle'),|" ${TRAVIS_BUILD_DIR}/vendor/composer/autoload_psr4.php
